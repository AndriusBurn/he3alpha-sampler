...
def main():
    ...
    E_maxes = np.array([0.706, 0.706, 0.868, 0.868, 1.292, 1.292, 1.759, 1.759]) # MeV
    ...
    n_steps = [50000, 50000, 50000, 50000, 50000, 50000, 50000, 50000]
    n_burns = [10000, 10000, 10000, 10000, 10000, 10000, 10000, 10000]

    # Parameters to set the number of different temperatures
    n_temps_lows = [5, 5, 5, 5, 5, 5, 5, 5] 
    n_temps_highs = [5, 5, 5, 5, 5, 5, 5, 5]

    # Use theory cov?
    use_theory_covs = [False, True, False, True, False, True, False, True]

    # Always write a comment for the run (at least just '\n'!!)
    comments = ['Run for VI paper: no theory cov, 0.7-0.7 som, ptemcee, 10,000:50,000 bs_C, 5 low 5 high temps', 
                'Run for VI paper: yes theory cov, 0.7-0.7 som, ptemcee, 10,000:50,000 bs_C, 5 low 5 high temps',
                'Run for VI paper: no theory cov, 0.7-0.9 som, ptemcee, 10,000:50,000 bs_C, 5 low 5 high temps',
                'Run for VI paper: yes theory cov, 0.7-0.9 som, ptemcee, 10,000:50,000 bs_C, 5 low 5 high temps',
                'Run for VI paper: no theory cov, 0.7-1.3 som, ptemcee, 10,000:50,000 bs_C, 5 low 5 high temps', 
                'Run for VI paper: yes theory cov, 0.7-1.3 som, ptemcee, 10,000:50,000 bs_C, 5 low 5 high temps',
                'Run for VI paper: no theory cov, 0.7-1.8 som, ptemcee, 10,000:50,000 bs_C, 5 low 5 high temps',
                'Run for VI paper: yes theory cov, 0.7-1.8 som, ptemcee, 10,000:50,000 bs_C, 5 low 5 high temps']
