...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov  30 11:17:21 EDT 2023

@author: Andrius Burnelis

This is a modification from the emcee "autocorr.py" that computes the autocorrelation time of MC samples.
"""
import numpy as np
import numpy.typing as npt

def next_pow_two(n: float) -> int:
...
def function_1d(x: npt.ArrayLike) -> npt.ArrayLike:
...
def auto_window(taus: int, c: int) -> int:
...
def integrated_time(x: npt.ArrayLike, c: int = 5, tol: int = 50, quiet: bool = False):
